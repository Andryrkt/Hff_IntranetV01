...
class FusionPdf
{
    ...
    public function genererFusion($FichierDom, $FichierAttache01, $FichierAttache02)
    {
        ...
        $chemin02 = $_SERVER['DOCUMENT_ROOT'] . '/Hffintranet_TEST/src/Controller/pdf/' . $FichierAttache01;
        ...
        $chemin03 = $_SERVER['DOCUMENT_ROOT'] . '/Hffintranet_TEST/src/Controller/pdf/' . $FichierAttache02;
        // Ajouter le deuxième fichier PDF
        ...
        //$pdf01->Output($_SERVER['DOCUMENT_ROOT'] . '/Hffintranet_TEST/Fusion/' . $FichierDom, 'I');
