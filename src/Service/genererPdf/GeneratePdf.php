...
class GeneratePdf 
{
    ...
    {
        $cheminFichierDistant = 'C:/DOCUWARE_TEST/ORDRE_DE_MISSION/' . $NumDom . '_' . $codeAg_serv . '.pdf';
        $cheminDestinationLocal = 'C:/wamp64/www/Upload_TEST/' . strtolower(substr($NumDom, 0, 3)) . '/' . $NumDom . '_'  . $codeAg_serv . '.pdf';
