...
class GeneratePdfDdp extends GeneratePdf
{
    ...
    public function genererPDF(DemandePaiement $ddp)
    {
        ...
        $pdf->setY(19);
        $pdf->Rect($pdf->GetX() + 20, $pdf->GetY(), $w50 * 2 - 40, 10);
        $pdf->Cell(0, 10, 'Service comptabilité – DEMANDE DE PAIEMENT ', 0, 1, 'C');
        ...
        $pdf->Line($pdf->GetX() + 1, $pdf->GetY() - 2, $pdf->GetX() + $pdf->GetStringWidth('TYPE DE DEMANDE') + 1, $pdf->GetY() - 2);
        ...
        $pdf->Line($pdf->GetX() + 1, $pdf->GetY() - 2, $pdf->GetX() + $pdf->GetStringWidth('DATE') + 1, $pdf->GetY() - 2);
        ...
        $pdf->Line($pdf->GetX() + 1, $pdf->GetY() - 2, $pdf->GetX() + $pdf->GetStringWidth('*Attention') + 1, $pdf->GetY() - 2);
        ...
        $pdf->Line($pdf->GetX() + 13.5, $pdf->GetY() - 2, $pdf->GetX() + $pdf->GetStringWidth('Mode de paiement') + 13.5, $pdf->GetY() - 2);
        $pdf->Line($pdf->GetX() + 96, $pdf->GetY() - 2, $pdf->GetX() + $pdf->GetStringWidth('Montant à payer') + 96, $pdf->GetY() - 2);
        $pdf->Line($pdf->GetX() + 167, $pdf->GetY() - 2, $pdf->GetX() + $pdf->GetStringWidth('Devise') + 167, $pdf->GetY() - 2);
        ...
        $pdf->Line($pdf->GetX() + 1, $pdf->GetY() - 2, $pdf->GetX() + $pdf->GetStringWidth('Liste des pièces jointes') + 1, $pdf->GetY() - 2);
