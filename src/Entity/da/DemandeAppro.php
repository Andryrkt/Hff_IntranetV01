...
class DemandeAppro
{
    ...
    public const STATUT_DW_A_VALIDE         = 'Soumis à validation';       /*_________ DA direct ________*/ // ! non cliquable par quiconque
    public const STATUT_DW_REFUSEE          = 'DA Refusée';                /*_________ DA direct ________*/ // ! non cliquable par quiconque
    public const STATUT_DW_VALIDEE          = 'DA Validée';                /*_________ DA direct ________*/ // ! non cliquable par quiconque
