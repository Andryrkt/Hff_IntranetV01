...
use App\Form\magasin\MagasinListOrSearchType;
...
{ 
    ...
    $data = [];
    $data[] = ['N° DIT', 'N° Or', "Pos Or", "Date Or", "cmde rel", "Pos liv", 'N° Intv', 'N° pie', 'Cst', 'Réf.', 'Dés', 'Qté alloc', 'Qté rés', 'Qté liv', 'Qté rel']; 
