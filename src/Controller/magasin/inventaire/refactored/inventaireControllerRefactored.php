...
class InventaireController extends BaseController
{
    ...
    public function listeInventaire(Request $request)
    {
        ...
        $this->sessionManagerService->set('inventaire_search_criteria', $criteriaTAb);
    ...
    public function inventaireDetail($numinv, Request $request)
    {
        ...
        $this->sessionManagerService->set('inventaire_detail_search_criteria', $criteriaTAb);
    ...
    public function exportExcelListe()
    {
        //verification si user connecter
        $this->verifierSessionUtilisateur();
        $criteriaTAb = $this->sessionManagerService->get('inventaire_search_criteria');
    ...
    {
        $criteriaTab = $this->sessionManagerService->get('inventaire_detail_search_criteria');
    ...
    public function bordereau_comptage($numInv, Request $request)
    {
        ...
        $criteriaTab = $criteria->toArray();
        $this->sessionManagerService->set('bordereau_search_criteria', $criteriaTab);
    ...
    public function pdfExport($numInv)
    {
        // Vérification si l'utilisateur est connecté
        $this->verifierSessionUtilisateur();
        $criteriaTab =  $this->sessionManagerService->get('bordereau_search_criteria');
        $data = $this->recupDataBordereau($numInv, $criteriaTab);
