...
class DaPropositionRefAvecDitController extends BaseController
{
    ...
    public function propositionDeReference($id, Request $request)
    {
        ...
        $formValidation = $this->getFormFactory()->createBuilder(DaPropositionValidationType::class, [], ['action' => $this->getUrlGenerator()->generate('da_validate_avec_dit', ['numDa' => $numDa])])->getForm();
