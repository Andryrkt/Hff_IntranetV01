...
<style>
  #intro {
    background-image: url("Views/assets/Hff.png");
    height: 100vh;
  }
        ...
        <div class="row justify-content-center">
          <div class="col-xl-5 col-md-8">
            <form class="bg-white rounded shadow-5-strong p-5" style="opacity: 85%" method="POST" action="/Hff_IntranetV01/index.php?action=Authentification">
              ...
              <div class="form-outline mb-4" data-mdb-input-init>
                <input type="password" id="form1Example2" class="form-control" name="Pswd" required />
                <label class="form-label" for="form1Example2">Mot de passe
                </label>
              </div>
