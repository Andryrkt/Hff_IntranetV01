            ...
            <div class="card-body">
                    ...
                    <div class=" row">
                        <div class="col">
                            ...
                            <select name="Agence_servSage" id="AgenceSage" class="form-select">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="nomPrenoms" name="nomPrenoms">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" name="numfrs" id="NUm_frs" class="form-control">
                        </div>
                        <div class="col">
                            <label for="AgenceIrium" class="label-form">Agence -service</label>
                            <select name="Agence_servIrum" id="AgenceIrium" class="form-select">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" id="banque" name="compte_bancaire" class="form-control">
                        </div>
                    </div>
