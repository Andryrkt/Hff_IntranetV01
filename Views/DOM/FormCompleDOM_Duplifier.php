...
<body onload=""><!-- Interne_externe();typeCatge(); - /Hffintranet/Views/tcpdf/examples/Flight_brief_pdf.php-->
    <div class="container">
        <div class="d-flex  flex-row-reverse  col">
            <div class="tablinks p-2 btn btn-outline-warning ">
                <a href="/Hffintranet/index.php?action=Dupliquer" style="text-decoration: none;color:black">Retour</a>
            </div>
        </div>
        <form action="/Hffintranet/index.php?action=EnvoyerImprime" method="POST" enctype="multipart/form-data" id="Formulaire">
            ...
            <?php foreach ($detailSelect as $Detail) :
                $length_Matricule = strlen($Detail['Matricule']);
                if ($length_Matricule <= 4) {
                    $check = 'Interne';
                } else {
                    $check = 'Externe';
                }
            ...
            ?>
                ...
                <div class="row" id="ext">
                    <div class="col-4 offset-6">
                        ...
                        <input type="text" name="Serv" class="form-control" id="Serv" value="<?php echo $Detail['Code_agence'] . ' ' . $Detail['Libelle_agence'] ?>" readonly>
                    </div>
                    <div class="col-4 offset-6">
                        <label for="LibServ" class="label-form">Service :</label>
                        <input type="text" name="LibServ" class="form-control" id="LibServ" value="<?php echo $Detail['Code_Service'] . ' ' . $Detail['Libelle_service'] ?>" readonly>
                    </div>
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <input name="typeMission" id="typeMission" class="form-control" value="<?php echo $Detail['Sous_type_document'] ?>" readonly />
                    </div>
                ...
                <div class="row">
                    <div class="col" id="categ">
                        ...
                        <input type="text" name="catego" id="catego" class="form-control" value="<?php echo $Detail['Categorie'] ?>">

                    </div>
                    <div class="col" id="categ">
                        <label for="catego" class="label-form"> Site:</label>
                        <input type="text" name="SiteRental" id="SiteRental" class="form-control" value="<?php echo $Detail['Site'] ?>">
                ...
                <div class="row" id="Interne">
                    <div class="col-6">
                        ...
                        <input type="text" name="matricule" id="matricule" class="form-control" value=" <?php echo $Detail['Matricule'] ?>" readonly>
                    </div>

                    <div class="col-6">
                        <label for="Nomprenoms" class="label-form"> Nom </label>
                        <input name="nomprenom" id="nomprenom" class="form-control" value="" readonly />
                    </div>
                    <div class="col-6">
                        <label for="prenoms" class="label-form"> Prénoms </label>
                        <input name="prenom" id="prenom" class="form-control" value="" readonly />
                    </div>
                ...
                <div class="row" id="externe">
                    <div class="col">
                        ...
                        <input type="text" name="namesExt" id="namesExt" class="form-control" value="" readonly>
                    </div>
                    <div class="col">
                        <label for="firstnamesExt" class="label-form"> Prénoms</label>
                        <input type="text" name="firstnamesExt" id="firstnamesExt" class="form-control" value="" readonly>
                    </div>
                    <div class="col">
                        <label for="cin" class="label-form"> CIN</label>
                        <input type="text" name="cin" id="cin" class="form-control" value="" readonly>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="date" name="dateDebut" id="dateDebut" class="form-control" style="border-color: orange;">
                    </div>
                    <div class="col">
                        <label for="heureDebut" class="label-form"> Heure début</label>
                        <input type="time" name="heureDebut" id="heureDebut" class="form-control" value="08:00" style="border-color: orange;">
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input type="text" name="motif" id="motif" class="form-control" style="border-color: orange;" maxlength="100">
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                ...
                <div class="row">
                    <div class="col-2">
                        ...
                        <input type="text" name="Devis" id="Devis" class="form-select">

                    </div>
                    <div class="col">
                        <label for="idemForfait" class="label-form"> Indemnité Forfaitaire Journalière(s)</label>
                        <input type="text" name="idemForfait" id="idemForfait" class="form-control" oninput="formatEtMettreAJour('idemForfait', 'TotalidemForfait');" onblur="sommeEtIndemnite('idemForfait','Nbjour','idemForfait01','TotalidemForfait');calculerSommeAll('TotalidemForfait', 'TotalAutredep','TotalIdemDeplac', 'Alldepense');negative('Alldepense') " style="border-color: orange;" value="<?php echo $Detail['Indemnite_Forfaitaire']?>" readonly />
                    </div>
                    <div class="col">
                        <label for="idemForfait01" class="label-form"> supplément journalier</label>
                        <input type="text" name="idemForfait01" id="idemForfait01" class="form-control" oninput="formatEtMettreAJour('idemForfait01');" onblur="sommeEtIndemnite('idemForfait','Nbjour','idemForfait01','TotalidemForfait');calculerSommeAll('TotalidemForfait', 'TotalAutredep','TotalIdemDeplac', 'Alldepense');negative('Alldepense') " style="border-color: orange;"  value="<?php echo $Detail['Doit_indemnite']?>"/>
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" name="modepaie" id="modepaie" class="form-control" value="">
                    </div>
                    ...
                    <input type="text" name="valModes" id="valModesp" class="form-control">
                </div> -->
                </div>
...
<script>
    $(document).ready(function() {
        function SiteValCatégorie() {
            var categorie = $('#catego').val();
            var typemission = $('#typeMission').val();
            var codeserv = $('#Serv').val().substring(0, 2);
            console.log("Categorie: " + categorie);
            console.log("Typemission: " + typemission);
            console.log("Codeserv: " + codeserv);
