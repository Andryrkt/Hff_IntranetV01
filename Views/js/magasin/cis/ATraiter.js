 ...
 * MISE EN MAJUSCULE
 * ===================================*/
const numDitInput = document.querySelector("#a_traiter_search_numDit");
const refPieceInput = document.querySelector(
  "#a_traiter_search_referencePiece"
);
 ...
 * ===================================*/
const numOrInput = document.querySelector("#a_traiter_search_numOr");
