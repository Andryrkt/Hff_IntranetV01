document.addEventListener("DOMContentLoaded", function () {
  ...
  const designationInput = document.querySelector(
    "#magasin_liste_or_a_traiter_search_designation"
  );
  ...
  const numDitInput = document.querySelector(
    "#magasin_liste_or_a_traiter_search_numDit"
  );
  const refPieceInput = document.querySelector(
    "#magasin_liste_or_a_traiter_search_referencePiece"
  );
  ...
  const numOrInput = document.querySelector(
    "#magasin_liste_or_a_traiter_search_numOr"
  );
...
const agenceInput = document.querySelector(
  "#magasin_liste_or_a_traiter_search_agence"
);
const serviceInput = document.querySelector(
  "#magasin_liste_or_a_traiter_search_service"
);
