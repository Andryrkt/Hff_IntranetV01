...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // ===================================================
  const fileErrors = document.getElementById("dit-observation-file-errors");
  ...
  // ========================================
  const fileInput = document.getElementById("dit_observation_fileNames");
  ...
  function isValidFile(file, maxSize = 5 * 1024 * 1024) {
    ...
    // Vérifier les doublons dans selectedFiles
  ...
  function createFileItem(file, index) {
    ...
    const icon = isImageFile(file.name) ? "fa-file-image" : "fa-file-pdf";
  ...
  function displayFile(event, file = null) {
    ...
    // Cas image
      ...
      viewer.innerHTML = `<img src="${filePath}" alt="${fileName}" style="max-width: 100%;"/>`;
    }
