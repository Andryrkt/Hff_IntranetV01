 ...
 */
export function mergeCellsRecursiveTable(cellPivotIndex) {
  ...
  const COLUMNS_TO_GROUP = [2, 3]; // indice des cellules à fusionner

  let rowSpanCount = 2; // initialiser à 0 le row span
