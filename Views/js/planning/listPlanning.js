    ...
    fetch(`${baseUrl}/detail-modal/${id}`, { signal })
      ...
      .then((data) => {
        ...
        if (data.data.length > 0) {
          if (data.data[0].numor.startsWith('5') || data.data[0].numor.startsWith('4') || data.data[0].numor.startsWith('3') || data.data[0].numor.startsWith('2')) {
          ...
          data.data.forEach((detail) => {
            ...
            if (detail.numor && detail.numor.startsWith('5') || detail.numor && detail.numor.startsWith('4') || detail.numor && detail.numor.startsWith('3') || detail.numor && detail.numor.startsWith('2')) {
              // Affichage
              let row = `<tr>
                        <td>${detail.numor}</td> 
                        <td>${detail.intv}</td> 
