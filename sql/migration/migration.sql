...
UPDATE demande_intervention
SET mail_demandeur = CASE 
    WHEN utilisateur_demandeur = 'avinass' THEN  'avinass.chendriah@hff.mg'
    WHEN utilisateur_demandeur = 'eoghan.carter' THEN  'eoghan.carter@hff.mg'
    WHEN utilisateur_demandeur = 'r.omega' THEN  'omega.razanadrasoa@hff.mg'
    WHEN utilisateur_demandeur = 'r.miora' THEN  'miora.randrianarivahy@hff.mg'
    WHEN utilisateur_demandeur = 'nantenaina' THEN  'nantenaina.soloarijaona@hff.mg'
    WHEN utilisateur_demandeur = 'Gillot' THEN  'gillot.emile@hff.mg'
    WHEN utilisateur_demandeur = 'falisoa' THEN  'falisoa.andrianaivo@hff.mg'
    WHEN utilisateur_demandeur = 'fenonirina' THEN  'fenonirina.rajoelison@hff.mg'
    WHEN utilisateur_demandeur = 'gjerome' THEN  'jerome.grand@hff.mg'
    ELSE '-'
END
WHERE num_migr=5

UPDATE demande_intervention
SET utilisateur_demandeur = CASE
    WHEN utilisateur_demandeur = 'r.estella' THEN 'Estella'
    WHEN utilisateur_demandeur = 'r.sharah' THEN 'sharah'
    WHEN utilisateur_demandeur = 'r.omega' THEN 'Omega'
    WHEN utilisateur_demandeur = 'r.miora' THEN 'Miora'
    WHEN utilisateur_demandeur = 's.nanten' THEN 'nantenaina'
    ELSE utilisateur_demandeur
END
WHERE num_migr=5

UPDATE demande_intervention
SET mail_demandeur = CASE 
    WHEN utilisateur_demandeur = 'r.estella' THEN  'estella.razafiarisoa@hff.mg'
    WHEN utilisateur_demandeur = 'r.sharah' THEN  'sharah.razanamiarandraibe@hff.mg'
    WHEN utilisateur_demandeur = 'r.omega' THEN  'omega.razanadrasoa@hff.mg'
    WHEN utilisateur_demandeur = 'r.miora' THEN  'miora.randrianarivahy@hff.mg'
    WHEN utilisateur_demandeur = 's.nanten' THEN  'nantenaina.soloarijaona@hff.mg'
    ELSE '-'
END
WHERE num_migr=5
