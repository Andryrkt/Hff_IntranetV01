...
(numero_demande_appro, demandeur, achat_direct, numero_demande_dit, niveau_urgence, objet_dal, detail_dal, agence_emmetteur_id, Service_emmetteur_id,agence_debiteur_id, service_debiteur_id, agence_service_emmeteur,agence_service_debiteur, date_creation, date_modification, date_heure_fin_souhaitee,statut_dal, est_validee, user_id, Devis_demander, da_type_id, numero_demande_appro_mere, code_societe)
SELECT d.numero_demande_appro, d.demandeur, 0, '', '', d.objet_dal, d.detail_dal, a_e.id, s_e.id, a_d.id, s_d.id, d.agence_service_emmeteur, d.agence_service_debiteur, d.date_creation, d.date_modification, d.date_heure_fin_souhaitee,d.statut_dal, 0, u.id, 0, 2, d.numero_demande_appro, 'HF'
FROM (
VALUES
