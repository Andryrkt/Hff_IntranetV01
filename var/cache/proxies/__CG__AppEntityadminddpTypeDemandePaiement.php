 ...
 */
class TypeDemandePaiement extends \App\Entity\admin\ddp\TypeDemandePaiement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeDemandePaiement $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setDateCreation(\DateTimeInterface $dateCreation): \App\Entity\admin\ddp\TypeDemandePaiement
    {
     ...
     * {@inheritDoc}
     */
    public function setDateModification(\DateTimeInterface $dateModification): \App\Entity\admin\ddp\TypeDemandePaiement
    {
